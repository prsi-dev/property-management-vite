...
import { ArrowLeft, Calendar, DollarSign, Mail, MessageSquare, Phone } from 'lucide-react';
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <Button
                    variant="default"
                    className="w-full"
                    onClick={() => toast('Offered Property')}
                  >
                    Offer Property
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full"
                    onClick={() => toast('Scheduled Viewing')}
                  >
                    Schedule Viewing
                  </Button>
                  <Button
                    variant="secondary"
                    className="w-full"
                    onClick={() => toast('Requested More Info')}
                  >
                    Request More Info
                  </Button>
                </CardContent>
