      ...
      <div className="flex-1 overflow-auto">
        <header className="bg-background sticky top-0 z-10 border-b px-6 py-3">
          <div className="flex items-center">
            <Link to="/families" className="mr-4">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      {/* <div>
                        <h3 className="mb-1 font-medium">Preferred Lease Length</h3>
                        <p className="text-muted-foreground text-sm">{family.leaseLength}</p>
                      </div> */}
                    </div>
                      ...
                      {/* <ul className="text-muted-foreground list-disc pl-5 text-sm">
                        {family.documents.map((doc, index) => (
                          <li key={index} className="mb-1">
                            <a to="#" className="text-primary hover:underline">
                              {doc}
                            </a>
                          </li>
                        ))}
                    ...
                    {family.maintenanceRequests.length > 0 && (
                      <>
                        <Separator />
                        <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">{family.preferredLocation}</div>
                  </div>
                  <div>
