...
export function CreateEventForm({ isOpen, onClose, properties, onSuccess }: CreateEventFormProps) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      status: 'PENDING',
      resourceId: properties.length > 0 ? properties[0].id : undefined,
      startDate: new Date(),
      endDate: undefined,
      amount: null,
      notes: '',
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      // Call onSuccess callback if provided, otherwise use window.location.reload
      if (onSuccess) {
        onSuccess();
      } else {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add event details below. Click save when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
